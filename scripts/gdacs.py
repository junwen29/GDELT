...
def run():
    ...
    for i in range(len(items)):
        try:
            ...
            event_object = events_utils.generate_event(title, description,content_paragraph_list, source, created_datetime,probable_event_date_list,
                                                       country, str(lat), str(lng), category_list, author_list)
